                    ...
                    if ($checking === true) {
                        $parsing['db_order'] = $this->api_model->select_data([
                            ...
                            'join' => [
                                ...
                                [
                                    'table' => 'db_order_pembayaran op',
                                    'on' => 'op.order_id = aa.order_id',
                                    'type' => 'left'
                                ],
                            ],
                            'where' => [
                        ...
                        if (empty($parsing['db_order'])) {
                            ...
                            $orders['downloadDocument'] = [
                                [
                                    'name' => "Purchase Order",
                                    'value' => "{$this->core['baseUrlCustomer']}unduh/order-doc/PO/{$parsing['db_order']->order_id}",
                                ],
                                [
                                    'name' => "Cetak SPK",
                                    'value' => "{$this->core['baseUrlCustomer']}unduh/order-doc/SPK/{$parsing['db_order']->order_id}",
                                ],
                                [
                                    'name' => "Cetak Invoice",
                                    'value' => "{$this->core['baseUrlCustomer']}unduh/order-doc/invoice/{$parsing['db_order']->order_id}",
                                ],
                            ];

                            if ($parsing['db_order']->op_id != null) {
                                $orders['downloadDocument'][] = [
                                    'name' => "Cetak Kwitansi",
                                    'value' => "{$this->core['baseUrlCustomer']}unduh/order-doc/kwitansi/{$parsing['db_order']->order_id}",
                                ];
                            }
                            ...
                            if (!empty($parsing['getBast'])) {
                                $orders['downloadDocument'][] = [
                                    'name' => "BAST Online",
                                    'value' => "{$this->core['baseUrlCustomer']}unduh/order-doc/{$parsing['db_order_bast']->bast_no}/{$parsing['db_order']->order_id}",
                                ];
                            }
