        ...
        <div class="card card-default">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control process" type="text" value="<?= $data['return_date'] ?>" disabled readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label text-right">Status Pengembalian</label>
                    <div class="col-sm-6">
                        <?php if (!empty($data['penalty_day'])) : ?>
                            <span class="badge badge-danger mt-2">Terlambat <?= $data['penalty_day'] ?> hari</span>
                        <?php else : ?>
