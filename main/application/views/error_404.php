						...
						<div class="card">
							<div class="card-body p-0 auth-header-box">
								<div class="text-center p-3">
									...
									<p class="text-muted  mb-0">Back to dashboard of Eureka Finance.</p>
								</div>
							</div>
							<div class="card-body">
								...
								<a class="btn btn-primary btn-block waves-effect waves-light" href="<?= base_url() ?>">Back to Dashboard <i class="fas fa-redo ml-1"></i></a>
							</div>
